...
namespace MiniRealisticAirways
{
    public static class Tutorial
    {
        ...
        private static void SetupWelcome(bool showInEn)
        {
            ...
            modal.description.gameObject.GetComponent<LinkHandler>().url = showInEn ? "https://m0pt5uret4t.feishu.cn/docx/VURHdwhonozWZcxJAaHcG5tPnUg?from=from_copylink" : "https://m0pt5uret4t.feishu.cn/docx/VaghdGDiEokiJmxeVRocJJonnhh?from=from_copylink";
